...
st.markdown("<h1 style='text-align: center; color: grey;'>DEEP FAKE IMAGE DETECTION USING MACHINE LEARNING</h1>", unsafe_allow_html=True)
...
st.markdown("""
---
Made with passion for Machine learning
""")
